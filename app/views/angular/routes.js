 ...
 myApp.config(["$routeProvider",function($routeProvider){
            ...
            .when('/vendor/update',{
                  templateUrl : "templates/vendorManagement.html",
                  controller  : "VendorManagementController",
                  controllerAs : "vendorManagementCtrl"
            })
            .when('/customer',{
                  templateUrl : "templates/customerManagement.html",
                  controller  : "VendorManagementController",
                  controllerAs : "customerManagementCtrl"
            })
            .when('/orders/all',{
