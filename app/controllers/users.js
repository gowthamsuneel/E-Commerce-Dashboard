  ...
  //-----API TO LOGOUT USER -----
    ...
    userRouter.post('/signup',auth.isLoggedIn,function(req,res){
     ...
     // ------ ADD VENDOR ----------
      ...
      userRouter.post('/addVendor',auth.checkLogin,function(req,res){
        var signupInfo = {};
      ...
      if(req.body.firstname!=undefined && req.body.lastname!=undefined && req.body.password!=undefined && 
        ...
        userModel.findOne({"email":req.body.email},function(err,user){
           var newOne = {
                    ...
                    lastName    : req.body.lastname,
                    email       : req.body.email,
                    password    : crypto.encrypt(key,req.body.password)
           };
            if(err){
                    var myResponse = responseGenerator.generate(true,err,500,null);
                    res.send(myResponse);
              ...
              if(err){
                ...
                var myResponse = responseGenerator.generate(false,"Vendor Updated",200,null);
                 res.send(myResponse);
              }
            })
    ...
    // ------- GET ALL VENDORS---------
      ...
      userRouter.get('/getAllVendors/:type',auth.checkLogin,function(req,res){
    
        userModel.find({"role":req.params.type},function(err,vendors){
          ...
          var myResponse = responseGenerator.generate(true,"All Vendors",200,vendors);
          res.send(myResponse);
    ...
    // ------- DELETE VENDOR---------
      ...
      userRouter.get('/deleteVendor/:id',auth.checkLogin,function(req,res){
    

        userModel.deleteOne({"_id":req.params.id},function(err,vendors){
          ...
          var myResponse = responseGenerator.generate(true,"Vendor deleted",200,vendors);
          res.send(myResponse);
